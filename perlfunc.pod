...
| In other systems like OS/2, DOS, and the various flavors of MS-Windows, your
| program sees a C<\n> as a simple C<\cJ>, but what's stored in text files are
| the two characters C<\cM\cJ>. 
| 
| В других системах, подобных OS/2, Dos и в различных разновидностях MS-Windows,
| ваша программа видит \n как один символ \cJ, но что хранится в текстовых файлах
| является двумя символами \cM\cJ.
| 
| В других системах, таких как OS / 2, DOS и различные
| разновидности MS-Windows, ваша программа видит \ n как простой \ cJ, но в
| текстовых файлах хранятся два символа \ cM \ cJ
